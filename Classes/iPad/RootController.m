...
- (void)viewDidLoad {
	...
	if ([[[UIDevice currentDevice] systemVersion] floatValue] < 4.0) {
		self.navigationItem.titleView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"logo~ipad.png"]] autorelease];
	}else {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[cnBetaAppDelegate_iPad instance].detailController.item = item;
	[[cnBetaAppDelegate_iPad instance].detailController refresh];
}
